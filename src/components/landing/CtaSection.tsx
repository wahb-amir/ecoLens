    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-slate-500 leading-relaxed font-medium">
          The planet doesn't need more data—it needs more action. Join the
          global telemetry network and start classifying waste in real-time.
        </p>
        ...
        <div className="mt-12 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-4">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2 text-black text-xs font-mono uppercase tracking-wider"
              >
