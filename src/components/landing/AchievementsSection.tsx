      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="mb-24">
          <motion.div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-emerald-600 font-mono text-[10px] font-black uppercase tracking-[0.3em]">
              Milestones
            </span>
          </motion.div>
          <motion.h2 className="text-4xl lg:text-6xl font-black text-slate-900 tracking-tighter max-w-2xl">
            Your impact on the <span className="text-emerald-500">planet</span>,
            quantified.
          </motion.h2>
        </div>
                ...
                >
                  <ach.icon
                    ...
                    className={cn(
                      ...
                      isActive ? ach.color : "text-slate-300",
                    )}
                  />
                </motion.button>
                ...
                <AnimatePresence>
                  {isActive && (
                    ...
                    >
                      <div
                        className={cn(
                          "mx-auto w-12 h-12 rounded-2xl flex items-center justify-center mb-4 bg-slate-50 shadow-inner",
                          ach.color,
                        )}
                      >
                        <ach.icon size={24} />
