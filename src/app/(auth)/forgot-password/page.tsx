...
export default function ForgotPasswordPage() {
  ...
  if (isSent) {
    return (
      <AuthLayout title="Check your inbox" subtitle="We've sent a recovery code to your email.">
        <div className="flex flex-col items-center space-y-6 text-center">
          ...
          <p className="text-sm text-slate-600">
            ...
            <button className="text-emerald-600 font-bold ml-1 hover:underline">try again</button>
          </p>
          <div className="w-full">
            <Link href="/otp-verify">
               <Button className="w-full bg-slate-900 text-white">Enter Code</Button>
            </Link>
            <Link href="/login">
              <Button variant="ghost" className="mt-4 w-full">Back to Login</Button>
            </Link>
          </div>
        </div>
      </AuthLayout>
