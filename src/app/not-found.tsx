    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#020817] text-white flex items-center justify-center">
      ...
      >
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg">
          ...
          <motion.h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-400">
            Lost in the Cosmos.
          </motion.h1>

          <motion.p className="text-slate-400 text-lg md:text-xl leading-relaxed mb-8">
            The coordinates you're looking for don't exist in our star maps. You
            may have taken a wrong turn at the last nebula.
          </motion.p>
          ...
          <motion.div>
            <Link href="/">
              <Button
                size="lg"
                className="group relative overflow-hidden bg-white text-slate-900 hover:bg-emerald-500 hover:text-white transition-all duration-300 px-8 py-6 text-lg font-bold rounded-xl"
              >
        ...
        <motion.div className="relative w-72 h-72 md:w-[500px] md:h-[500px] flex-shrink-0">
